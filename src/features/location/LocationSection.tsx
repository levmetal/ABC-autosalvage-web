          ...
          >
            <div className="space-y-4">
              {contactDetails.map((item) => (
                ...
                >
                  {/* Icon Badge */}
                  <div className="shrink-0 w-11 h-11 rounded-full bg-[var(--color-primary)]/10 border border-[var(--color-primary)]/20 flex items-center justify-center group-hover:shadow-[0_0_20px_rgba(255,95,0,0.2)] transition-shadow duration-300">
                  ...
                  <div>
                    ...
                    <span 
                      className="text-sm sm:text-base font-body font-black group-hover:text-[var(--color-primary)] transition-colors duration-300"
                      style={{ color: '#FFFFFF' }}
                    >
                      {item.value}
                    </span>
            ...
            >
              <span className="text-sm font-heading font-bold uppercase tracking-widest text-[var(--color-primary)]">
                Get Directions
              </span>
              <ExternalLink className="w-4 h-4 text-[var(--color-primary)] group-hover:translate-x-1 group-hover:-translate-y-0.5 transition-transform duration-300" />
            </a>
          </div>
