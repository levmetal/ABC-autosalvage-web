...
import quote from '../../assets/images/common/Quote.webp'
import offer from '../../assets/images/common/Offer.webp'
import cash from '../../assets/images/common/Cash.webp'
...
export const StickyWorkflow: React.FC = () => {
  ...
  return (
    <section ref={containerRef} id="process" className="relative bg-[var(--color-base)] min-h-screen">
